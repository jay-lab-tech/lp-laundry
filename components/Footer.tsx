      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-2xl font-bold text-white mb-6">Laundry Bersih Jaya</h2>
            <p className="max-w-md mb-8 leading-relaxed">
              Jasa laundry terpercaya yang mengutamakan kebersihan, higienitas, dan kecepatan. Pakaian Anda ditangani secara profesional dengan harga yang sangat terjangkau.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#testimonials" className="hover:text-blue-500 transition-colors">Testimoni</a></li>
              <li><a href={WHATSAPP_URL} className="hover:text-blue-500 transition-colors">Hubungi Kami</a></li>
            </ul>
          </div>
          <div>
            <h3 className="text-white font-bold mb-6">Kontak & Lokasi</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span>Jl. Melati No. 123, Kel. Sukamaju, Kec. Bersih, Kota Harapan, 12345</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span>Setiap Hari: 07.00 - 21.00</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="border-t border-slate-800 pt-10 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} Laundry Bersih Jaya. Created by jay-lab-tech / Azhar Noermansyah for UMKM.</p>
        </div>
      </div>
    </footer>
  );
